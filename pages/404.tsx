...
const NotFoundAll = (props: Props) => {
  ...
  return (
    <>
      ...
      <main className=" max-w[1200px] px-6 d-flex w-full mx-auto ">
        <div className="min-h-screen max-w-md mx-auto py-24 flex-col flex items-center justify-center text-center">
          <h1 className="text-lg md:text-2xl capitalize font-semibold mb-3">
            Xin lỗi, Trang này không có sẵn!
          </h1>
          <p className="text-xs md:text-base">
            Xin lỗi, chúng tôi không thể tìm thấy trang bạn đang tìm kiếm. Hãy
            kiểm tra lại đường dẫn của bạn.
          </p>
          <div>
            <svg
              className="h-full sm:h-72 w-full my-10 md:my-16 lg:my-20"
              viewBox="0 0 480 360"
